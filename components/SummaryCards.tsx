...
export const SummaryCards: React.FC<SummaryCardsProps> = ({
  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <h3 className="text-2xl font-extrabold text-slate-900 mt-0.5">
              {totalCount} <span className="text-xs font-medium text-slate-400">devices</span>
            </h3>
          </div>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <h3 className="text-2xl font-extrabold text-emerald-700 mt-0.5">
              {onCount} <span className="text-xs font-medium text-emerald-600">active</span>
            </h3>
          </div>
          <div className="w-9 h-9 rounded-xl bg-emerald-100 text-emerald-700 flex items-center justify-center border border-emerald-300">
      ...
      <div className="p-4 rounded-2xl bg-white border border-slate-200/90 shadow-2xs">
        <div className="flex items-center justify-between">
          <div>
            ...
            <h3 className="text-2xl font-extrabold text-slate-700 mt-0.5">
              {offCount} <span className="text-xs font-medium text-slate-400">off</span>
            </h3>
          </div>
      ...
      {/* Card 4: Network Mode */}
      <div className="p-4 rounded-2xl bg-white border border-slate-200/90 shadow-2xs col-span-2 lg:col-span-1">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-xs font-semibold text-slate-500 uppercase">
              System Routing

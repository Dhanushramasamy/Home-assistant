...
import { X, Lightbulb, Fan, Plug, Cpu, CheckCircle2, AlertTriangle, Info } from "lucide-react";
      ...
      <div className="relative w-full max-w-lg bg-white border border-slate-200 rounded-2xl shadow-xl overflow-hidden text-slate-800">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 bg-slate-50/50">
          <div>
            ...
            <p className="text-xs text-slate-500">Configure device name & ESP32 IP address</p>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3.5 py-2 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:border-teal-500 focus:bg-white"
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-900 focus:outline-none focus:border-teal-500"
              >
                {Array.from(new Set(["Bedroom", "Hall", "Kitchen", "Living Room", ...existingRooms])).map(
                  (r) => (
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              >
                ...
                <div className="text-[11px] text-slate-500">Direct HTTP</div>
              </button>
              ...
              >
                ...
                <div className="text-[11px] text-slate-500">Central Pi 5</div>
              </button>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center space-x-1.5 bg-slate-50 p-2 rounded-xl border border-slate-200">
              <input
                ...
                className="w-12 text-center py-1 bg-white border border-slate-200 rounded-lg text-xs font-mono text-teal-700 font-bold focus:outline-none focus:border-teal-500"
              />
          ...
          <div className="pt-2 flex items-center justify-end space-x-2 border-t border-slate-100">
            ...
            <button
              ...
              className="px-5 py-2 rounded-xl bg-teal-600 hover:bg-teal-700 text-white font-bold text-xs shadow-xs active:scale-95 transition-all disabled:opacity-50"
            >
